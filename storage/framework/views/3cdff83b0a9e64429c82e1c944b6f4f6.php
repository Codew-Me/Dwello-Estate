    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h1 class="text-3xl font-bold text-dwello-brown mb-2"><?php echo e($property->title); ?></h1>
                    <p class="text-xl text-gray-600"><?php echo e($property->location); ?></p>
                </div>
                <div class="text-right">
                    <div class="text-3xl font-bold text-dwello-brown">$<?php echo e(number_format($property->price)); ?></div>
            ...
            <div class="flex items-center space-x-6">
                <div class="flex items-center">
                    ...
                    <span class="text-gray-600"><?php echo e($property->bedrooms); ?> Bedrooms</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-5 h-5 text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"></path>
                    </svg>
                    <span class="text-gray-600"><?php echo e($property->bathrooms); ?> Bathrooms</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-5 h-5 text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4"></path>
                    </svg>
                    <span class="text-gray-600"><?php echo e(number_format($property->area)); ?> sq ft</span>
                </div>
                <div class="flex items-center">
                    <span class="text-gray-600 capitalize"><?php echo e($property->type); ?></span>
                </div>
            </div>
        </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <?php if($property->image): ?>
                        <img src="<?php echo e(asset($property->image)); ?>" alt="<?php echo e($property->title); ?>" class="w-full h-96 object-cover">
                    <?php else: ?>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-dwello-brown capitalize"><?php echo e($property->type); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Price:</span>
                            <span class="font-bold text-dwello-brown">$<?php echo e(number_format($property->price)); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Bedrooms:</span>
                            <span class="font-medium text-dwello-brown"><?php echo e($property->bedrooms); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Bathrooms:</span>
                            <span class="font-medium text-dwello-brown"><?php echo e($property->bathrooms); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Area:</span>
                            <span class="font-medium text-dwello-brown"><?php echo e(number_format($property->area)); ?> sq ft</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Status:</span>
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($property->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                <?php echo e($property->status ? 'Available' : 'Sold'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php else: ?>
                            <div class="text-center">
                                ...
                                <div class="space-y-2">
                                    <a href="<?php echo e(route('login')); ?>" class="block w-full bg-dwello-brown text-white py-3 px-4 rounded-lg hover:bg-opacity-90 transition duration-300 font-medium">
                                        Login to Inquire
                                    </a>
                                    <a href="<?php echo e(route('register')); ?>" class="block w-full bg-dwello-light-beige text-dwello-brown py-3 px-4 rounded-lg hover:bg-opacity-90 transition duration-300 font-medium">
                                        Create Account
                                    </a>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6">
                    ...
                    <a href="<?php echo e(route('agents.index')); ?>" class="w-full bg-dwello-light-beige text-dwello-brown py-3 px-4 rounded-lg hover:bg-opacity-90 transition duration-300 font-medium text-center block">
                        View Our Agents
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\estate\resources\views/properties/show.blade.php ENDPATH**/ ?>