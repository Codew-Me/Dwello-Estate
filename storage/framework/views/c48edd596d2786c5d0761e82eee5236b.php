        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
            <div class="flex flex-col lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-8">
                ...
                <div class="flex-shrink-0">
                    <?php if($agent->image): ?>
                        <img src="<?php echo e(asset('storage/' . $agent->image)); ?>" alt="<?php echo e($agent->name); ?>" class="w-32 h-32 rounded-full object-cover border-4 border-dwello-brown shadow-lg">
                    <?php else: ?>
                        <div class="w-32 h-32 bg-gradient-to-br from-dwello-brown to-dwello-light-beige rounded-full flex items-center justify-center border-4 border-dwello-brown shadow-lg">
                            <span class="text-white text-4xl font-bold"><?php echo e(substr($agent->name, 0, 1)); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="flex-1 text-center lg:text-left">
                    <div class="mb-4">
                        <h1 class="text-4xl font-bold text-dwello-brown mb-2"><?php echo e($agent->name); ?></h1>
                        <p class="text-xl text-gray-700 font-medium mb-3"><?php echo e($agent->specialization ?? 'Real Estate Professional'); ?></p>
                        ...
                        <div class="inline-flex items-center bg-gradient-to-r from-dwello-brown to-dwello-light-beige text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
                            ...
                            <?php echo e($agent->experience_years); ?>+ Years Experience
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                    <div class="flex items-center mb-6">
                        ...
                        <h2 class="text-3xl font-bold text-dwello-brown">About <?php echo e($agent->name); ?></h2>
                    </div>
                    <div class="prose prose-lg max-w-none">
                        <p class="text-gray-700 leading-relaxed text-lg mb-6"><?php echo e($agent->bio); ?></p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                            <div class="bg-gradient-to-r from-dwello-beige to-dwello-tan rounded-2xl p-6">
                                ...
                                <p class="text-gray-700 text-sm">Specialized in <?php echo e($agent->specialization ?? 'luxury real estate'); ?> with deep market knowledge and proven track record.</p>
                            </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center p-4 bg-gray-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <a href="mailto:<?php echo e($agent->email); ?>" class="text-gray-600 hover:text-dwello-brown transition duration-300"><?php echo e($agent->email); ?></a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-gray-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <a href="tel:<?php echo e($agent->phone); ?>" class="text-gray-600 hover:text-dwello-brown transition duration-300"><?php echo e($agent->phone); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl p-6 border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <a href="mailto:<?php echo e($agent->email); ?>" class="block w-full bg-gradient-to-r from-dwello-brown to-dwello-light-beige text-white py-4 px-6 rounded-xl hover:shadow-lg transition duration-300 text-center font-semibold">
                            <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                            </svg>
                            Send Email
                        </a>
                        <a href="tel:<?php echo e($agent->phone); ?>" class="block w-full bg-dwello-light-beige text-dwello-brown py-4 px-6 rounded-xl hover:shadow-lg transition duration-300 text-center font-semibold border-2 border-dwello-brown">
                            <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            Call Now
                        </a>
                        <a href="<?php echo e(route('properties.index')); ?>" class="block w-full bg-dwello-light-beige text-dwello-brown py-4 px-6 rounded-xl hover:shadow-lg transition duration-300 text-center font-semibold border-2 border-dwello-brown">
                            <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-6 border border-gray-100">
                        ...
                        <div class="bg-gradient-to-r from-dwello-beige to-dwello-tan rounded-xl p-4">
                            <div class="flex items-center">
                                ...
                                <span class="font-semibold text-dwello-brown text-lg"><?php echo e($agent->specialization); ?></span>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\estate\resources\views/agents/show.blade.php ENDPATH**/ ?>