        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                    <img src="<?php echo e(asset('img1.png')); ?>" 
...
<section class="py-8 -mt-8 relative z-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-dwello-light-beige rounded-2xl p-4 shadow-lg">
            <form action="<?php echo e(route('search')); ?>" method="GET" class="flex flex-col lg:flex-row gap-3 items-center">
                <?php echo csrf_field(); ?>
                <!-- Location Input -->
                ...
                <div class="relative flex-1 w-full">
                    <select name="type" 
                        ...
                        <option value="condo" <?php echo e(request('type') == 'condo' ? 'selected' : ''); ?>>Condo</option>
                        <option value="cabin" <?php echo e(request('type') == 'cabin' ? 'selected' : ''); ?>>Cabin</option>
                    </select>
                ...
                <div class="relative flex-1 w-full">
                    <select name="price_range" 
                        ...
                        <option value="0-500000" <?php echo e(request('price_range') == '0-500000' ? 'selected' : ''); ?>>Under $500K</option>
                        <option value="500000-1000000" <?php echo e(request('price_range') == '500000-1000000' ? 'selected' : ''); ?>>$500K - $1M</option>
                        <option value="1000000-2000000" <?php echo e(request('price_range') == '1000000-2000000' ? 'selected' : ''); ?>>$1M - $2M</option>
                        <option value="2000000-5000000" <?php echo e(request('price_range') == '2000000-5000000' ? 'selected' : ''); ?>>$2M - $5M</option>
                        <option value="5000000-999999999" <?php echo e(request('price_range') == '5000000-999999999' ? 'selected' : ''); ?>>Above $5M</option>
                    </select>
                    <svg class="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-dwello-brown pointer-events-none" 
                         fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative order-1 lg:order-1">
                <div class="relative rounded-2xl overflow-hidden">
                    <img src="<?php echo e(asset('img2.png')); ?>" 
                         alt="Modern luxury house" 
                         class="w-full h-96 lg:h-[500px] object-cover">
                </div>
            </div>
...
<section id="popular-residences" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <?php $__currentLoopData = $featuredProperties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!-- Property Card <?php echo e($index + 1); ?> -->
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition duration-300">
                    <!-- Image -->
                    <div class="relative h-64">
                        <img src="<?php echo e(asset($property->image)); ?>" 
                    ...
                    <div class="px-6 py-6 bg-dwello-tan">
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <span class="font-bold text-dwello-brown"><?php echo e($property->city); ?>, <?php echo e($property->state); ?></span>
                        </div>
                        ...
                        <div class="flex items-center mb-6">
                            ...
                            <div class="flex items-center mr-8">
                                ...
                                <span class="text-dwello-brown font-medium"><?php echo e($property->bedrooms); ?> Rooms</span>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="text-dwello-brown font-medium"><?php echo e(number_format($property->area)); ?> sq ft</span>
                            </div>
                        </div>
                ...
                <div id="testimonialsContainer" class="flex transition-transform duration-500 ease-in-out">
                    ...
                    <div class="w-full md:w-1/3 flex-shrink-0 px-4">
                        <div class="bg-white rounded-2xl overflow-hidden card-shadow h-full flex flex-col">
                            <div class="relative">
                                <img src="<?php echo e(asset('im4.png')); ?>" 
                                     alt="Luxury bedroom" 
                                     class="w-full h-48 object-cover rounded-t-2xl">
                            </div>
                            <div class="p-6 bg-dwello-tan flex-1 flex flex-col">
                                <div class="flex items-center mb-4">
                                    <img src="<?php echo e(asset('person1.jpeg')); ?>" 
                                         alt="Sarah Nguyen" 
                    ...
                    <div class="w-full md:w-1/3 flex-shrink-0 px-4">
                        <div class="bg-white rounded-2xl overflow-hidden card-shadow h-full flex flex-col">
                            <div class="relative">
                                <img src="<?php echo e(asset('im5.png')); ?>" 
                                     alt="Modern living space" 
                                     class="w-full h-48 object-cover rounded-t-2xl">
                            </div>
                            <div class="p-6 bg-dwello-tan flex-1 flex flex-col">
                                <div class="flex items-center mb-4">
                                    <img src="<?php echo e(asset('person2.jpg')); ?>" 
                    ...
                    <div class="w-full md:w-1/3 flex-shrink-0 px-4">
                        <div class="bg-white rounded-2xl overflow-hidden card-shadow h-full flex flex-col">
                            <div class="relative">
                                <img src="<?php echo e(asset('im6.png')); ?>" 
                                     alt="Cozy bedroom" 
                                     class="w-full h-48 object-cover rounded-t-2xl">
                            </div>
                            <div class="p-6 bg-dwello-tan flex-1 flex flex-col">
                                <div class="flex items-center mb-4">
                                    <img src="<?php echo e(asset('person3.jpeg')); ?>" 
                                         alt="Emily Johnson" 
                                         class="w-12 h-12 rounded-full mr-4">
                                    <div class="flex-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\estate\resources\views/home.blade.php ENDPATH**/ ?>